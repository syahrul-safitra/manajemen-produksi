                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_costumer') is-invalid @enderror "
                                        ...
                                        value="{{ @old('nama_costumer', $order->nama_costumer) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ @old('tanggal_pesanan', $order->tanggal_pesanan) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('jenis_pesanan') is-invalid @enderror "
                                        ...
                                        value="{{ @old('jenis_pesanan', $order->jenis_pesanan) }}">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('jumlah') is-invalid @enderror "
                                        ...
                                        value="{{ @old('jumlah', $order->jumlah) }}" min="1"
                                        max="{{ $stokProduct }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('total') is-invalid @enderror "
                                        name="total" id="total" placeholder=""
                                        value="{{ @old('total', $order->total) }}" min="1" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="status" value="blm_lunas" name="status"
                                            class="custom-control-input" @checked(@old('status', $order->status) === 'blm_lunas')>
                                        <label class="custom-control-label" for="status">Belum Lunas</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="perempuan" name="status" value="lunas"
                                            class="custom-control-input" @checked(@old('status', $order->status) === 'lunas')>
